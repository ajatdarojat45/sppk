...
@section('title')
   Computer - FIMZ Cemerlang Bangsa
@endsection
@section('content')
   <div class="row wrapper border-bottom white-bg page-heading">
      <div class="col-lg-10">
         ...
         <ol class="breadcrumb">
            ...
            <li class="active"><strong>Computer</strong></li>
         </ol>
      </div>
      <div class="col-lg-2">
      </div>
      ...
      <div class="row">
          <div class="col-lg-12 animated fadeInRight">
              <div class="ibox-content">
                  <h2 class="page-header">Computer ({{ $computers->count() }})</h2>
                      ...
                      <table id="example1" class="table table-hover table-striped">
                          ...
                          <tbody>
                              ...
                              <tr class="read">
                                 ...
                                 <td class="text-center">{{ $computer->code }}</td>
   ...
   <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
       <div class="modal-dialog">
           <div class="modal-content animated bounceInRight">
               ...
               <form action="{{ route('computer/store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
