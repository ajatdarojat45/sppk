...
@section('title')
   Componnet Create - FIMZ Cemerlang Bangsa
@endsection
@section('content')
                              ...
                              <fieldset class="form-horizontal">
                                    ...
                                    <div class="col-sm-10">
                                       @if ($errors->has('merk'))
                                          <span class="help-block">
                                             <strong style="color: red">{{ $errors->first('merk') }}</strong>
                                          </span>
                                       @endif
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       @if ($errors->has('invoice'))
                                          <span class="help-block">
                                             <strong style="color: red">{{ $errors->first('invoice') }}</strong>
                                          </span>
                                       @endif
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       @if ($errors->has('pr'))
                                          <span class="help-block">
                                             <strong style="color: red">{{ $errors->first('pr') }}</strong>
                                          </span>
                                       @endif
