   ...
   <div class="row wrapper border-bottom white-bg page-heading">
      <div class="col-lg-10">
         ...
         <ol class="breadcrumb">
            ...
            <li class="active"><strong>Duty</strong></li>
         </ol>
      </div>
      <div class="col-lg-2">
      </div>
      ...
      <div class="row">
          <div class="col-lg-12 animated fadeInRight">
              <div class="ibox-content">
                  <h2 class="page-header">Duty ({{ $duties->count() }})</h2>
                      ...
                      <table id="example1" class="table table-hover table-striped">
                          ...
                          <tbody>
                              ...
                              <tr class="read">
                                 ...
                                 <td class="text-left">{{ $duty->name }}</td>
                                 <td class="text-center">{{ $duty->created_at }}</td>
