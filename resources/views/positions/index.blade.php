...
@section('title')
   Position - FIMZ Cemerlang Bangsa
@endsection
@section('content')
   <div class="row wrapper border-bottom white-bg page-heading">
      <div class="col-lg-10">
         ...
         <ol class="breadcrumb">
            ...
            <li class="active"><strong>Position</strong></li>
         </ol>
      </div>
      <div class="col-lg-2">
      </div>
      ...
      <div class="row">
          <div class="col-lg-12 animated fadeInRight">
              <div class="ibox-content">
                  <h2 class="page-header">Position ({{ $positions->count() }})</h2>
                          ...
                          <tbody>
                              ...
                              <tr class="read">
                                 ...
                                 <td class="text-center">
                                    <a href="{{route('position/destroy', $position->id)}}" class="btn btn-danger btn-sm btn-outline"><i class="fa fa-trash"></i> </a>
                                 </td>
                              </tr>
                              @endforeach
                          </tbody>
   ...
   <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
       <div class="modal-dialog">
           <div class="modal-content animated bounceInRight">
               ...
               <form action="{{ route('position/store') }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
